...
(function() {
    ...
    var composeQuery = function(query) {
        ...
        var req_query_length = binary_pack('N', query.length); // Watch out for Unicode string length
        ...
        sys.puts('Request sent:' + request + '[' + request.length + ']');
